const DATA = {
  ...
  sacrifices: [
    {id:'burnt', emoji:'🔥', title:'번제', group:'🔥 5대 제사', desc:'전부 드리는 헌신', ready:true,
      badges:['🔥 5대 제사','📖 자원 제사','🐂 짐승 제물','❤️ 온전한 헌신'],
      sections:[
        {key:'names', title:'📛 다른 이름', type:'names', rows:[['개역개정','번제'],['다른 표현','온전히 태우는 제사'],['영어','Burnt Offering'],['히브리어','올라(Olah)'],['뜻','제물을 모두 불살라 하나님께 올려 드리는 제사']]},
        {key:'definition', title:'📖 번제란?', body:['번제는 제물을 하나님께 온전히 불살라 드리는 제사입니다.', '제물을 남기지 않고 모두 태워 드림으로써, 자신의 삶 전체를 하나님께 맡기고 드리는 헌신과 예배를 나타냅니다.', '레위기에 나오는 가장 기본적인 제사이며, 속죄와 헌신의 의미가 함께 담겨 있습니다.']},
        {key:'offering', title:'🐂 무엇을 드렸을까?', type:'flow', intro:'형편에 따라 드릴 수 있는 제물이 달랐습니다.', items:['🐂 소','🐑 양','🐐 염소','🕊️ 산비둘기나 집비둘기'], outro:'하나님께 나아가는 길은 부자에게만 열린 것이 아니었습니다. 형편에 따라 드릴 수 있도록 길을 열어 두셨습니다.'},
        {key:'practice', title:'🏛 어떻게 드렸을까?', type:'flow', intro:'제물을 가져온 사람이 안수하고, 제사장이 피를 뿌린 뒤 제물 전체를 태웠습니다.', items:['🙋 제물을 가져옴','🙏 제물 머리에 안수','🔪 제물을 잡음','🩸 피를 제단 사방에 뿌림','🔥 제물을 모두 태움','🌫️ 하나님께 향기로운 제사']},
        {key:'why', title:'✨ 왜 중요할까?', body:['번제는 하나님께 모든 것을 맡기고 자신을 온전히 드리는 예배를 가르쳐 줍니다.', '제물이 대신 죽고 불살라진다는 점에서 죄를 가볍게 여기지 않게 하며, 동시에 하나님께 전적으로 헌신하는 삶을 보여 줍니다.', '예배는 일부만 드리는 것이 아니라, 삶 전체를 하나님께 드리는 것임을 알려 줍니다.']},
        {key:'date', title:'📅 언제 드렸을까?', body:['매일 아침과 저녁에 드렸습니다.', '안식일과 절기에도 드렸습니다.', '개인이 자원하여 하나님께 드릴 수도 있었습니다.', '번제는 이스라엘 예배의 기본 리듬을 이루는 제사였습니다.']},
        {key:'flow', title:'➡ Flow', type:'flow', items:['🐂 제물','🙏 안수','🩸 피','🔥 모두 태움','❤️ 온전한 헌신']},
        {key:'meaning', title:'💭 Meaning', type:'flow', items:['❤️ 나 자신','🔥 하나님께 드림','🙏 헌신','✨ 삶의 예배'], outro:'번제는 나의 일부가 아니라 삶 전체를 하나님께 드리는 예배의 마음을 가르칩니다.'},
        {key:'panorama', title:'🌍 Panorama', type:'flow', items:['🔥 번제','⛺ 성막','🏛️ 성전','✝️ 예수님의 희생','❤️ 삶의 예배'], outro:'번제는 성막과 성전 예배의 중심에 있었고, 예수님의 온전한 희생과 성도의 삶의 예배로 이어집니다.'},
        {key:'jesus', title:'✝️ 예수님과의 연결', type:'flow', items:['🔥 번제','🙏 온전한 순종','✝️ 십자가','❤️ 완전한 헌신','⛪ 삶의 예배'], outro:'예수님은 자신의 몸을 온전히 하나님께 드리신 완전한 제물이십니다. 번제는 그리스도의 순종과 십자가의 헌신을 미리 보여 줍니다.'},
        {key:'verses', title:'📚 관련 성경', body:['구약: 레위기 1장, 출애굽기 29장', '신약 연결: 히브리서 10장, 로마서 12:1']},
        {key:'summary', title:'💎 이것만 기억하세요', body:['번제는 제물을 모두 하나님께 드림으로써, 나 자신을 하나님께 온전히 드리는 헌신의 제사입니다.']}
      ]
    },
    {id:'grain', emoji:'🌾', title:'소제', group:'🔥 5대 제사', desc:'곡식으로 드리는 감사', ready:true,
      badges:['🔥 5대 제사','📖 자원 제사','🌾 곡식 제물','🙏 감사와 헌신'],
      sections:[
        {key:'names', title:'📛 다른 이름', type:'names', rows:[['개역개정','소제'],['다른 표현','곡식 제사'],['영어','Grain Offering'],['히브리어','민하(Minchah)'],['뜻','곡식과 기름, 유향을 하나님께 드리는 제사']]},
        {key:'definition', title:'📖 소제란?', body:['소제는 짐승이 아니라 곡식으로 하나님께 드리는 제사입니다.', '고운 가루와 기름, 유향을 드리며 하나님께서 주신 양식과 삶의 은혜에 감사했습니다.', '피 흘림이 없는 제사이지만, 하나님께 감사와 헌신을 표현하는 중요한 예배였습니다.']},
        {key:'offering', title:'🌾 무엇을 드렸을까?', type:'flow', intro:'소제의 기본 제물은 곡식과 기름, 유향이었습니다.', items:['🌾 고운 가루','🫒 기름','🌫️ 유향','🧂 소금','🚫 누룩과 꿀은 금지'], outro:'소금은 언약의 변함없음을 떠올리게 하고, 누룩은 부패를 상징할 수 있어 제단에 태우지 않았습니다.'},
        {key:'practice', title:'🏛 어떻게 드렸을까?', type:'flow', intro:'제사장은 일부를 기념물로 태우고, 나머지는 제사장의 몫으로 돌렸습니다.', items:['🌾 고운 가루를 준비','🫒 기름을 붓고 유향을 얹음','🧂 소금을 더함','🔥 일부를 제단에 태움','👨‍🦳 나머지는 제사장 몫','🙏 하나님께 감사']},
        {key:'why', title:'✨ 왜 중요할까?', body:['소제는 하나님께서 주신 양식과 삶의 모든 공급을 기억하게 하는 제사입니다.', '이스라엘은 수확과 일상의 먹거리가 자신의 힘만으로 된 것이 아니라 하나님께서 주신 은혜임을 고백했습니다.', '소제는 감사가 예배가 되고, 일상의 노동도 하나님께 드려질 수 있음을 보여 줍니다.']},
        {key:'date', title:'📅 언제 드렸을까?', body:['번제와 함께 드리는 경우가 많았습니다.', '절기와 여러 제사에 곁들여 드렸습니다.', '개인이 감사와 헌신의 마음으로 드릴 수도 있었습니다.']},
        {key:'flow', title:'➡ Flow', type:'flow', items:['🌾 곡식','🫒 기름','🌫️ 유향','🔥 기념물로 태움','🙏 감사와 헌신']},
        {key:'meaning', title:'💭 Meaning', type:'flow', items:['🍞 일용할 양식','🙏 감사','❤️ 헌신','✨ 거룩한 삶'], outro:'소제는 하나님께서 주신 일상의 은혜를 기억하고 감사로 응답하는 예배입니다.'},
        {key:'panorama', title:'🌍 Panorama', type:'flow', items:['🌾 소제','🏜️ 광야의 만나','🌾 가나안의 수확','🍞 생명의 떡','⛪ 감사의 삶'], outro:'소제는 하나님께서 먹이시고 돌보시는 은혜를 성경 전체의 흐름 속에서 보여 줍니다.'},
        {key:'jesus', title:'✝️ 예수님과의 연결', type:'flow', items:['🌾 곡식 제물','🍞 생명의 떡','✝️ 예수님의 헌신','🙏 감사의 삶'], outro:'예수님은 하늘에서 내려온 생명의 떡이십니다. 소제는 하나님께 드리는 감사와 예수님 안에서 누리는 참된 양식을 생각하게 합니다.'},
        {key:'verses', title:'📚 관련 성경', body:['구약: 레위기 2장, 레위기 6:14~23', '신약 연결: 요한복음 6:35, 에베소서 5:2']},
        {key:'summary', title:'💎 이것만 기억하세요', body:['소제는 곡식으로 드리는 감사의 제사이며, 하나님께서 주신 삶의 모든 공급을 인정하는 예배입니다.']}
      ]
    },
    {id:'peace', emoji:'🤝', title:'화목제', group:'🔥 5대 제사', desc:'하나님과의 교제', ready:true,
      badges:['🔥 5대 제사','📖 자원 제사','🤝 교제와 나눔','🎉 감사의 기쁨'],
      sections:[
        {key:'names', title:'📛 다른 이름', type:'names', rows:[['개역개정','화목제'],['다른 표현','평화의 제사, 교제의 제사'],['영어','Peace Offering / Fellowship Offering'],['히브리어','쉘라밈(Shelamim)'],['뜻','하나님과 화목하고 함께 나누는 제사']]},
        {key:'definition', title:'📖 화목제란?', body:['화목제는 하나님과의 화목과 교제를 기뻐하며 드리는 제사입니다.', '제물의 일부는 하나님께 태워 드리고, 일부는 제사장에게 주며, 일부는 제사를 드린 사람이 가족과 함께 먹었습니다.', '그래서 화목제는 제사 중에서 기쁨과 나눔의 성격이 가장 강합니다.']},
        {key:'offering', title:'🐂 무엇을 드렸을까?', type:'flow', intro:'흠 없는 짐승을 드렸습니다.', items:['🐂 소','🐑 양','🐐 염소'], outro:'화목제는 감사, 서원, 자원하는 마음으로 드릴 수 있었습니다.'},
        {key:'practice', title:'🏛 어떻게 드렸을까?', type:'flow', intro:'하나님께 드리고, 제사장과 가족이 함께 나누어 먹었습니다.', items:['🙋 제물을 가져옴','🙏 안수','🩸 피를 제단에 뿌림','🔥 기름 부분을 하나님께 태움','👨‍🦳 제사장 몫을 나눔','🍽️ 가족과 함께 식사']},
        {key:'why', title:'✨ 왜 중요할까?', body:['화목제는 죄 사함 이후 하나님과 평화를 누리는 기쁨을 보여 줍니다.', '하나님께 드리는 예배가 두려움만이 아니라 감사와 교제와 기쁨임을 가르칩니다.', '함께 먹는 식사는 하나님과의 관계가 회복되었고 공동체가 함께 기뻐한다는 표시였습니다.']},
        {key:'date', title:'📅 언제 드렸을까?', body:['감사할 일이 있을 때 드렸습니다.', '서원을 이루었을 때 드렸습니다.', '자원하여 하나님께 기쁨으로 드릴 수 있었습니다.']},
        {key:'flow', title:'➡ Flow', type:'flow', items:['🙏 감사','🐂 제물','🩸 피','🔥 하나님께 드림','🍽️ 함께 먹음','🤝 화목과 교제']},
        {key:'meaning', title:'💭 Meaning', type:'flow', items:['❤️ 관계 회복','🙏 감사','🍽️ 나눔','🎉 기쁨'], outro:'화목제는 하나님과 화목한 백성이 감사와 기쁨으로 하나님 앞에서 살아가는 모습을 보여 줍니다.'},
        {key:'panorama', title:'🌍 Panorama', type:'flow', items:['🤝 화목제','⛺ 성막의 식탁','🏛️ 성전 예배','🍷 주의 만찬','⛪ 교회의 교제'], outro:'화목제의 식탁은 하나님과의 교제, 그리고 신약의 성만찬과 성도의 교제를 생각하게 합니다.'},
        {key:'jesus', title:'✝️ 예수님과의 연결', type:'flow', items:['🤝 화목','✝️ 십자가','❤️ 하나님과 화해','🍷 주의 만찬','⛪ 한 공동체'], outro:'예수님은 십자가로 하나님과 우리 사이의 막힌 담을 허무시고 참된 화목을 이루셨습니다.'},
        {key:'verses', title:'📚 관련 성경', body:['구약: 레위기 3장, 레위기 7:11~21', '신약 연결: 로마서 5:1, 에베소서 2:13~18, 고린도전서 10:16~17']},
        {key:'summary', title:'💎 이것만 기억하세요', body:['화목제는 하나님과 화목한 백성이 감사와 기쁨으로 함께 나누는 교제의 제사입니다.']}
      ]
    },
    {id:'sin', emoji:'🩸', title:'속죄제', group:'🔥 5대 제사', desc:'죄 사함과 정결', ready:true,
      badges:['🔥 5대 제사','📖 의무 제사','🩸 죄 사함','🧼 정결 회복'],
      sections:[
        {key:'names', title:'📛 다른 이름', type:'names', rows:[['개역개정','속죄제'],['다른 표현','죄를 위한 제사'],['영어','Sin Offering'],['히브리어','하타트(Chattat)'],['뜻','죄와 부정을 속하고 정결하게 하는 제사']]},
        {key:'definition', title:'📖 속죄제란?', body:['속죄제는 죄를 용서받고 하나님 앞에서 정결을 회복하기 위해 드리는 제사입니다.', '특히 모르고 지은 죄나 부정함으로 인해 하나님과의 관계가 흐트러졌을 때 드렸습니다.', '속죄제는 죄가 하나님 앞에서 반드시 다루어져야 한다는 사실을 보여 줍니다.']},
        {key:'offering', title:'🐂 무엇을 드렸을까?', type:'flow', intro:'대상과 상황에 따라 제물이 달랐습니다.', items:['🐂 제사장이나 온 회중: 수송아지','🐐 지도자: 숫염소','🐑 일반 백성: 암염소나 어린 암양','🕊️ 가난한 사람: 비둘기','🌾 더 가난한 사람: 고운 가루'], outro:'하나님은 죄를 가볍게 보지 않으시지만, 누구든지 속죄의 길에 나아올 수 있도록 하셨습니다.'},
        {key:'practice', title:'🏛 어떻게 드렸을까?', type:'flow', intro:'피를 통해 죄와 부정을 속했습니다.', items:['😔 죄를 깨달음','🐂 제물을 가져옴','🙏 안수','🔪 제물을 잡음','🩸 피를 뿌리거나 바름','🔥 기름을 태움','🧼 정결 회복']},
        {key:'why', title:'✨ 왜 중요할까?', body:['속죄제는 죄가 하나님과의 관계를 깨뜨린다는 사실을 가르쳐 줍니다.', '죄는 그냥 넘어가는 것이 아니라 하나님께서 정하신 방식으로 속죄되어야 했습니다.', '피 흘림을 통해 죄의 심각성과 하나님의 용서가 함께 드러납니다.']},
        {key:'date', title:'📅 언제 드렸을까?', body:['모르고 지은 죄를 깨달았을 때 드렸습니다.', '정결 예식과 관련하여 드렸습니다.', '제사장, 지도자, 회중, 개인 모두 상황에 따라 드릴 수 있었습니다.', '속죄일에는 더 큰 차원의 속죄 제사가 드려졌습니다.']},
        {key:'flow', title:'➡ Flow', type:'flow', items:['😔 죄','🐂 제물','🙏 안수','🩸 피','🧼 정결','❤️ 용서']},
        {key:'meaning', title:'💭 Meaning', type:'flow', items:['😔 죄를 인정','🩸 속죄','🧼 깨끗하게 됨','🤝 관계 회복'], outro:'속죄제는 죄를 숨기는 것이 아니라 하나님 앞에 가지고 나아가 용서와 정결을 받는 길을 보여 줍니다.'},
        {key:'panorama', title:'🌍 Panorama', type:'flow', items:['🩸 속죄제','⛺ 성막','🙏 속죄일','✝️ 십자가','👑 영원한 속죄'], outro:'속죄제는 속죄일과 연결되고, 궁극적으로 예수님의 십자가에서 완전한 속죄로 성취됩니다.'},
        {key:'jesus', title:'✝️ 예수님과의 연결', type:'flow', items:['😔 우리의 죄','🩸 예수님의 피','✝️ 십자가','❤️ 죄 사함','🙏 하나님께 나아감'], outro:'예수님은 우리의 죄를 위해 단번에 자신을 드리셨고, 그 피로 영원한 속죄를 이루셨습니다.'},
        {key:'verses', title:'📚 관련 성경', body:['구약: 레위기 4장, 레위기 6:24~30, 레위기 16장', '신약 연결: 히브리서 9장, 히브리서 10장, 요한일서 1:7~9']},
        {key:'summary', title:'💎 이것만 기억하세요', body:['속죄제는 죄를 용서받고 하나님 앞에서 정결을 회복하기 위해 드리는 제사입니다.']}
      ]
    },
    {id:'guilt', emoji:'💰', title:'속건제', group:'🔥 5대 제사', desc:'배상과 회복', ready:true,
      badges:['🔥 5대 제사','📖 의무 제사','💰 배상','🤝 관계 회복'],
      sections:[
        {key:'names', title:'📛 다른 이름', type:'names', rows:[['개역개정','속건제'],['다른 표현','허물을 위한 제사, 배상 제사'],['영어','Guilt Offering / Trespass Offering'],['히브리어','아샴(Asham)'],['뜻','잘못으로 생긴 손해를 배상하고 관계를 회복하는 제사']]},
        {key:'definition', title:'📖 속건제란?', body:['속건제는 하나님이나 이웃에게 손해를 끼친 잘못을 해결하기 위해 드리는 제사입니다.', '속죄제와 비슷하게 죄를 다루지만, 속건제는 특히 손해를 배상하고 관계를 회복하는 데 초점이 있습니다.', '죄의 용서뿐 아니라 실제적인 책임과 회복이 함께 요구되었습니다.']},
        {key:'offering', title:'🐏 무엇을 드렸을까?', type:'flow', intro:'기본적으로 숫양을 드리고, 손해에 대한 배상을 함께 했습니다.', items:['🐏 숫양','💰 손해 배상','➕ 오분의 일 추가','🙏 하나님께 제사','🤝 관계 회복'], outro:'속건제는 “미안합니다”에서 끝나지 않고, 실제 손해를 갚는 책임까지 포함했습니다.'},
        {key:'practice', title:'🏛 어떻게 드렸을까?', type:'flow', intro:'잘못을 인정하고 배상한 뒤 제사를 드렸습니다.', items:['😔 잘못을 깨달음','💰 손해를 배상','➕ 오분의 일을 더함','🐏 숫양을 제물로 드림','🩸 피를 뿌림','🤝 관계 회복']},
        {key:'why', title:'✨ 왜 중요할까?', body:['속건제는 죄가 하나님과의 관계뿐 아니라 이웃과의 관계도 깨뜨린다는 사실을 보여 줍니다.', '진정한 회개는 말로만 끝나지 않고, 손해를 갚고 관계를 회복하려는 책임 있는 행동으로 이어져야 합니다.', '하나님은 용서와 함께 정의로운 회복도 중요하게 여기십니다.']},
        {key:'date', title:'📅 언제 드렸을까?', body:['성물에 대해 잘못했을 때 드렸습니다.', '이웃에게 손해를 끼쳤을 때 드렸습니다.', '거짓 맹세나 부정직한 행동으로 피해를 주었을 때 드렸습니다.', '배상과 제사가 함께 필요했습니다.']},
        {key:'flow', title:'➡ Flow', type:'flow', items:['😔 잘못','💰 배상','➕ 더하여 갚음','🐏 제사','🤝 회복']},
        {key:'meaning', title:'💭 Meaning', type:'flow', items:['😔 책임 인정','💰 손해 배상','🙏 하나님께 용서','🤝 관계 회복'], outro:'속건제는 회개가 마음의 고백만이 아니라 책임 있는 회복으로 이어져야 함을 가르쳐 줍니다.'},
        {key:'panorama', title:'🌍 Panorama', type:'flow', items:['💰 속건제','⚖️ 하나님의 공의','🤝 이웃과의 회복','✝️ 그리스도의 대속','❤️ 새 삶의 책임'], outro:'속건제는 죄의 용서와 실제적인 회복을 함께 보여 주며, 예수님의 대속과 성도의 책임 있는 삶으로 연결됩니다.'},
        {key:'jesus', title:'✝️ 예수님과의 연결', type:'flow', items:['😔 우리의 허물','✝️ 예수님의 대속','❤️ 용서','🤝 회복','🚶 새 삶'], outro:'예수님은 우리의 허물과 죄를 대신 담당하셨습니다. 그 은혜를 받은 사람은 하나님과 이웃 앞에서 회복을 이루는 삶으로 나아가야 합니다.'},
        {key:'verses', title:'📚 관련 성경', body:['구약: 레위기 5:14~6:7, 레위기 7:1~10', '신약 연결: 이사야 53:10, 누가복음 19:8~10, 베드로전서 2:24']},
        {key:'summary', title:'💎 이것만 기억하세요', body:['속건제는 잘못을 배상하고 관계를 회복함으로써 책임 있는 회개를 배우게 하는 제사입니다.']}
      ]
    }
  ]
};
